...
// I2C bus clock, for the crosstalk experiment. ⚠ DAISY ADDITION -- the Pico's menu has no such row.
// Cycling re-initialises the bus AND the panel, so it is a visible, deliberate action.
