...
STYLES = {
    ...
    "stomp_clap": dict(
        ...
        note="Foot-stomp and handclap: kick on all four beats, claps on 2 and 4, nothing else. "
             "Shuffle grid so the claps can lean late.",
        # "Am I Wrong" (Keb' Mo') lives on exactly this: a stomped floor and a clap.
        pattern={
            "kick":  [(0, 1.0), (3, 0.80), (6, 0.90), (9, 0.80)],
            "clap":  [(3, 0.90), (9, 0.95)],
        },
        fill_from=9,
        fill={"clap": [(9, 0.95), (11, 0.70)]}),

    "delta": dict(
        fn="delta", bpm=92, bars=4, div=12, swing=0.0,
        note="Sparse Delta shuffle: kick on 1 and 3, rim on 2 and 4, a whisper of hat. Room for the guitar.",
        # Walking Blues / Cross Road Blues / Sweet Home Chicago: the guitar carries the groove,
        # the drums only mark the bar.
        pattern={
            "kick":  [(0, 0.95), (6, 0.75)],
            "rim":   [(3, 0.70), (9, 0.80)],
            "hat":   [(0, 0.30), (3, 0.22), (6, 0.30), (9, 0.24)],
        },
        fill_from=9,
    ...
    "ballad": dict(
        ...
        # Desperado: the piano and voice carry it; the bed only keeps the bar honest.
        pattern={
            "kick":    [(0, 0.85)],
            "rim":     [(8, 0.45)],
            "brushit": [(4, 0.35), (12, 0.40)],
        },
        fill_from=12,
